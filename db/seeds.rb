...
dog13 = Animal.create(name: Faker::Creature::Dog.name, breed: "Dalmatian", bio: Faker::Creature::Dog.meme_phrase, age: 5, shelter: shelter, img:"https://images.unsplash.com/photo-1550953581-a75aa86fec20?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80")
dog14 = Animal.create(name: Faker::Creature::Dog.name, breed: "Pekinese Mix", bio: Faker::Creature::Dog.meme_phrase, age: 3, shelter: shelter, img:"https://images.unsplash.com/photo-1585948010691-75fedc3061d2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=858&q=80")
dog15 = Animal.create(name: Faker::Creature::Dog.name, breed: "Boston Terrier", bio: Faker::Creature::Dog.meme_phrase, age: 4, shelter: shelter, img:"https://images.unsplash.com/photo-1543490258-4131d44881d7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2167&q=80")
dog16 = Animal.create(name: Faker::Creature::Dog.name, breed: "Greyhound Mix", bio: Faker::Creature::Dog.meme_phrase, age: 6, shelter: shelter, img:"https://images.unsplash.com/photo-1570796632619-4a9e44c210ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=582&q=80")
